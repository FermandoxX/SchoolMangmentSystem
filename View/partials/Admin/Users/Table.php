        ...
        <tbody class="admintablebody"> 
         ...
         foreach($Pagination['data'] as $row){
           echo "<tr>
                ...
                <td>{$row["address"]}</td>";
            echo'<td><a href ="/SchoolMangmentSystem/index.php/Users/AdminDelete?result='.$row[$PrimaryKeyofTable].'"><i class="fa fa-trash" style="font-size:18px; color:red; margin-right:5px; cursor:pointer;"></i></a><span>or</span><a 
            href ="/SchoolMangmentSystem/index.php/Users/AdminUpdate?result='.$row[$PrimaryKeyofTable].'"><i class="fa fa-edit"
