        ...
        <tbody class="admintablebody"> 
         ...
         foreach($Pagination['data'] as $row){
           echo "<tr>
            ...
            echo'<td><a href ="/SchoolMangmentSystem/index.php/Users/TeacherDelete?result='.$row[$PrimaryKeyofTable].'"><i class="fa fa-trash" style="font-size:18px; color:red; margin-right:5px; cursor:pointer;"></i></a><span>or</span><a 
            href ="/SchoolMangmentSystem/index.php/Users/TeacherUpdate?result='.$row[$PrimaryKeyofTable].'"><i class="fa fa-edit"
