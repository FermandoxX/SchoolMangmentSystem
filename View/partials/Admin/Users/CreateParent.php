...
<?php
         ...
         for ($i=0; $i < $length ; $i++) { 
        echo "<form class='DivCreateAdminBody' method='post' action='/SchoolMangmentSystem/index.php/Users/ParentsCreate'>";
         echo
         ...
         <p class='CreateAdminBodyLowParagraph'>Provide Parent $Colums_name[$i]</p>
         </div>";
        }
       ...
       echo '<input type="checkbox" name=Student[] value='.$row['student_id'].'>
       ...
       echo '</div>
        ...
        echo  "<button class='CreateAdminBodyButton'>Create Parent</button>
        </form>";
